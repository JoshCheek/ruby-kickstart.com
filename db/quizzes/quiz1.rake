namespace :db do  
  ...
  task :quiz1 do
    Quiz.add 1, 'Chapter 1 Quiz' do
      ...
      problem 'What is the suffix for ruby files?', :solution => 1, :options => %w(.ruby .rb .exe .rub)
      ...
      problem 'What is text called?', :match => /\bstrings?\b/i
      ...
      problem 'What does a method return?', :solution => 1, :options => ['nil', 'the last instruction', 'the last object evaluated', 'its parameters', 'itself']
      ...
      problem 'How do you invoke a method named "add", and pass it the numbers 1 and 2?', :solution => 6, :options => [
        'add(1, 2)',
        'add(1 2)',
        'add 1, 2',
        '(add 1, 2)',
